ig.module(
	...
	.requires(
		...
		'game.levels.ingame',
		'game.levels.menu',
		// 'game.levels.editor', // Level Editor
	...
	.defines(function () {
		...
		MyGame = ig.Game.extend({
			name: "MJS-geometry-missile", // Name of the game, used as part of the key name in localstorage
			...
			start: function () {
				...
				// ig.game.editorMode = (getQueryVariable("editorMode") == 'true' || getQueryVariable("editorMode") == 1); // Level Editor
